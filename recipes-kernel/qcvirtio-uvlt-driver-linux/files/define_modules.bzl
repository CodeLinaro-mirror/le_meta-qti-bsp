...
def define_modules(target, variant):
    ...
    ddk_module(
        name = "{}_coqos-uvlt".format(kernel_build_variant),
        ...
        out = "coqos-uvlt.ko",
        hdrs = [
            "include/uapi/linux/uvlt_ioctl.h",
        ],
        includes = [
            "include",
        ],
    ...
    copy_to_dist_dir(
        name = "{}_coqos-uvlt_dist".format(kernel_build_variant),
        data = [
            ":{}_coqos-uvlt".format(kernel_build_variant),
        ],
...
def define_uapi_headers():
    ddk_headers(
        name = "coqos_uvlt_uapi_headers",
        hdrs = ["include/uapi/linux/uvlt_ioctl.h"],
