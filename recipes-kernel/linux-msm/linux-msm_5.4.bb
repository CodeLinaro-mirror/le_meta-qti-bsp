...
COMPATIBLE_MACHINE = "genericarmv8|sdxlemur|scuba|qrbx210-rbx|sa2150p|sa2150p-nand|sa410m|sa410m-televm|qcs610|qrb5165|sa515m|sa415m"

SRC_URI:append:sdxlemur = "${@bb.utils.contains('MACHINE_FEATURES', 'qti-audio', 'file://0001-ALSA-uapi-add-check-to-avoid-duplicate-include-of-ti.patch', '', d)}"
SRC_URI:append:sdxlemur = "${@bb.utils.contains('DISTRO_FEATURES', 'dm-verity', 'file://gluebi.cfg', '', d)}"

S         =  "${WORKDIR}/kernel/msm-5.4"
PR        =  "r0"

# QCS610 specific
SRC_URI:append:qcs610 = "file://qcs610.cfg"
SRC_URI:append:qcs610 = "file://android_binderfs.cfg"
SRC_URI:append:qcs610 = "file://squashfs.cfg"

SRC_URI:append:qrb5165 = " file://qca6390.cfg"
