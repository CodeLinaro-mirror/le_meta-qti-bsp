...
do_populate_kernel_header_artifacts() {
    mkdir -p ${B}/headers
    cp -a ${KERNEL_PREBUILT_DISTDIR}/${LE_TARGET}_${KERNEL_HEADERS_VARIANT}defconfig_kernel-uapi-headers.tar.gz ${B}/headers
    cd ${B}/headers
    tar -xvzf ${LE_TARGET}_${KERNEL_HEADERS_VARIANT}defconfig_kernel-uapi-headers.tar.gz
