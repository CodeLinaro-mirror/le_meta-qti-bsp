...
EXTRA_OEMAKE_8x96autogvmquin = "${MY_TARGET} TOOLCHAIN_PREFIX='${TARGET_PREFIX}' LIBGCC='${LIBGCC}' EMMC_BOOT=1 SIGNED_KERNEL=1 VERIFIED_BOOT=1 DEFAULT_UNLOCK=true"
EXTRA_OEMAKE_8x96autogvmred = "${MY_TARGET} TOOLCHAIN_PREFIX='${TARGET_PREFIX}' LIBGCC='${LIBGCC}' EMMC_BOOT=1 SIGNED_KERNEL=1 VERIFIED_BOOT=1 DEFAULT_UNLOCK=true"
EXTRA_OEMAKE_8x96autonapier = "${MY_TARGET} TOOLCHAIN_PREFIX='${TARGET_PREFIX}' LIBGCC='${LIBGCC}' EMMC_BOOT=1 SIGNED_KERNEL=1 VERIFIED_BOOT=1 DEFAULT_UNLOCK=true"
