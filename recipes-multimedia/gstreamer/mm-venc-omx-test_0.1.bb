...
FILESPATH  =+ "${WORKSPACE}:"
SRC_URI    = "file://gstreamer/gst-sample/mm-venc-omx-test"
SRC_DIR = "${WORKSPACE}/gstreamer/gst-sample/mm-venc-omx-test"

S = "${WORKDIR}/gstreamer/gst-sample/mm-venc-omx-test"
