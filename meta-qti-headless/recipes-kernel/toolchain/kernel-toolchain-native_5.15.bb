...
SRC_URI = " \
    ...
    ${BASE_GIT_PATH}/prebuilts/gcc/linux-x86/host/x86_64-linux-glibc2.17-4.8/.git;protocol=${PROTO};name=glibc;destsuffix=${BASE_PATH}/prebuilts/gcc/linux-x86/host/x86_64-linux-glibc2.17-4.8 \
    ${BASE_GIT_PATH}/prebuilts/ndk-r23/.git;protocol=${PROTO};name=ndk;destsuffix=${BASE_PATH}/prebuilts/ndk-r23 \
    ${BASE_GIT_PATH}/build/kernel/.git;protocol=${PROTO};name=build-kernel;destsuffix=${BASE_PATH}/build/kernel \
"

SRCREV_clang = "${AUTOREV}"
SRCREV_build-tools = "${AUTOREV}"
SRCREV_kernel-build-tools = "${AUTOREV}"
