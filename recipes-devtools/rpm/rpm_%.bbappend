...
#Below CLO is mirror from "github.com/rpm-software-management/rpm"
SRC_URI  = "git://git.codelinaro.org/clo/le/rpm.git;protocol=https;branch=caf_migration/rpm/rpm-4.14.x"
