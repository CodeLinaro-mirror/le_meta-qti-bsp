...
SRC_URI = "${CAF_LA_GIT}/platform/build.git;protocol=${CAF_PROT};nobranch=1;tag=${CAF_TAG};destsuffix=android_compat/build/tools/fs_config;subpath=tools/fs_config"
