...
SRC_URI = "${CLO_LA_GIT}/platform/external/bouncycastle;protocol=https;branch=caf_migration/LA.UM.5.6.c1;destsuffix=bouncycastle;name=bouncycastle"
...
#######################################
SRC_URI +=  "${CLO_LA_GIT}/platform/system/extras;protocol=https;branch=caf_migration/LA.UM.5.6.c1;destsuffix=extras;name=verity"
...
#######################################
SRC_URI +=  "${CLO_LA_GIT}/platform/build_repo;protocol=https;branch=caf_migration/LA.UM.5.6.c1;destsuffix=security;name=security"
