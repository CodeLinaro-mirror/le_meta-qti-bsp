...
#######################################
SRC_URI +=  "git://git.codelinaro.org/clo/la/platform/build;protocol=https;nobranch=1;rev=26bfd792b59eb163dfbc8602a931868fbb35bad4;destsuffix=security;subpath=target/product/security;name=security"
