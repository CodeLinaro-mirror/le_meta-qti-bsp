...
RDEPENDS:${PN} = " \
        ...
        ${@bb.utils.contains('DISTRO_FEATURES', 'qti-omx', 'gstreamer1.0-omx mm-vdec-omx-test-lite mm-venc-omx-test-lite vdec-omx-sample venc-omx-sample secure-video-app', '', d)} \
