...
SRC_URI = "git://source.codeaurora.org/quic/le/platform/hardware/qcom/media.git;protocol=${PROTO};destsuffix=hardware/qcom/media;nobranch=1"
...
# media project Makefile.am changed, "--enable-build-mm-video" is useless
