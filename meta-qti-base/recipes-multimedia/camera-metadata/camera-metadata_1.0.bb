...
SRC_URI = "git://source.codeaurora.org/quic/le/platform/vendor/qcom-opensource/le-framework.git;protocol=https;destsuffix=frameworks/camera_metadata;subpath=camera_metadata;nobranch=1"  
