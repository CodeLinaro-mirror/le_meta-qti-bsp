...
SRC_URI = "${PATH_TO_REPO}/wlan/qcacld-3.0/.git;protocol=${PROTO};destsuffix=wlan/qcacld-3.0;usehead=1 \
           ...
           file://WCNSS_qcom_cfg_qca6490.ini \
           file://0001-qcacld-3.0-Fill-content-of-defconfig-for-qca6490.patch \
           "
SRCREV = "${AUTOREV}"
...
EXTRA_OEMAKE_append_qtigvmi3 = " WLAN_CFG_OVERRIDE=${_WLAN_CFG_OVERRIDE_GVM}"
...
do_install() {
    ...
    install -D -m 0644 ${WORKDIR}/WCNSS_qcom_cfg_qca6490.ini ${FIRMWARE_PATH}/WCNSS_qcom_cfg.ini
