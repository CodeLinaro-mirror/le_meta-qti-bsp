...
SRC_URI_append_automotive = " git://source.codeaurora.org/platform/vendor/qcom/wlan.git;protocol=https;destsuffix=device/qcom/wlan/msm_auto;subpath=msm_auto;nobranch=1"
