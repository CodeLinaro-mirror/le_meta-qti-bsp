...
SRC_URI = "git://source.codeaurora.org/platform/vendor/qcom-opensource/wlan/qcacld-3.0.git;protocol=https;destsuffix=wlan/qcacld-3.0;nobranch=1;name=qcacld \
