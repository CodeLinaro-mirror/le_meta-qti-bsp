...
SRC_URI  = "git://source.codeaurora.org/quic/le/platform/vendor/qcom-opensource/le-framework.git;protocol=https;destsuffix=frameworks/binder;subpath=binder;nobranch=1"
