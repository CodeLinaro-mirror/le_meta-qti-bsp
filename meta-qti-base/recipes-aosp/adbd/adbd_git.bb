...
DEPENDS += "libselinux libbase fs-mgr glib-2.0"
...
ADBD_PN = "system-core-adbd"

inherit autotools pkgconfig systemd useradd

USERADD_PACKAGES = "${ADBD_PN}"
GROUPADD_PARAM:${ADBD_PN} = "adb"

USERADD_PARAM:${ADBD_PN} = "-g adb --no-create-home --shell /bin/false adb"
