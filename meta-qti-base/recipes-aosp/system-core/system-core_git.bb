...
DEPENDS += "ext4-utils glib-2.0 libbase libcutils libmincrypt libselinux libutils  openssl adbd"
DEPENDS += "${@bb.utils.contains_any('MACHINE', 'sa8775 8540', 'linux-ark-headers', 'linux-msm-headers', d)}"
