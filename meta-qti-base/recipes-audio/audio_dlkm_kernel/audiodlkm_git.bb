...
SRC_URI = "git://source.codeaurora.org/platform/vendor/opensource/audio-kernel.git;protocol=https;destsuffix=vendor/qcom/opensource/audio-kernel;nobranch=1"
