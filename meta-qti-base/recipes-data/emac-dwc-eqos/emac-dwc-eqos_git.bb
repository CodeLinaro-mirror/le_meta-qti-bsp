...
SRC_URI   =  "git://source.codeaurora.org/platform/vendor/qcom-opensource/data-kernel.git;protocol=https;destsuffix=data-kernel/drivers/emac-dwc-eqos;subpath=drivers/emac-dwc-eqos;nobranch=1"
