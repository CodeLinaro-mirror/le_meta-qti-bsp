...
TECHPACK_MODULES = "apps_pinctrl.ko scm_user_intf.ko qcom_dload_mode.ko vfio_iommu_qcom.ko iommu_iova_map.ko kiumd.ko qcom_uscmi.ko kryo_arm64_edac.ko kiumd_kgsl.ko mhi_ep_net.ko profiler.ko qcom_ethqos_filter.ko arm-smmu-qcom-fusa.ko pinctrl_fusa.ko qcom_l3_cache_config.ko iommu_faults.ko qcom_vdev.ko dmabuf_share.ko"
