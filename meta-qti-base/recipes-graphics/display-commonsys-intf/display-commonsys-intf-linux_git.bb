...
SRC_URI = "git://source.codeaurora.org/platform/vendor/qcom-opensource/display-commonsys-intf.git;protocol=https;destsuffix=vendor/qcom/opensource/commonsys-intf/display;nobranch=1"
