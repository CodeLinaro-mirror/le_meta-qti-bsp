...
SRC_URI = "git://git.codelinaro.org/clo/la/platform/system/libufdt.git;protocol=https;destsuffix=system/libufdt;branch=caf_migration/keystone/p-keystone-qcom-release \
