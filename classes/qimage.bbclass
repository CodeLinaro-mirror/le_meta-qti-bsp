...
QIMGCLASSES += "${@bb.utils.filter('MACHINE_FEATURES', 'dm-verity-none dm-verity-bootloader dm-verity-initramfs dm-verity-initramfs-v2 dm-verity-initramfs-v3 dm-verity-cpio-cmdline', d)}"
