...
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/fault_injection_khab_test_export.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/fault_injection_khab_test_import.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/fault_injection_khab_test_open.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/fault_injection_khab_test_unexport.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/fault_injection_khab_test_unimport.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_close.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_export.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_import.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_open.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_query.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_recv.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_send.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_unexport.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_test_unimport.ko"
FILES:${PN} += "${base_libdir}/modules/${KERNEL_VERSION}/unit_test/khab_unittest_kprobe.ko"
