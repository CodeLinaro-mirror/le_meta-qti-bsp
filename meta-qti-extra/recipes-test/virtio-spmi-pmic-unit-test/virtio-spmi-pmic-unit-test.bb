...
SRC_URI = "${PATH_TO_REPO}/vendor/qcom/opensource/unit-test/kernel-unit-test/.git;protocol=${PROTO};destsuffix=vendor/qcom/opensource/unit-test/kernel-unit-test/virtio_spmi_pmic_unit_test;subpath=virtio_spmi_pmic_unit_test;usehead=1"

SRCREV  = "${AUTOREV}"

S = "${WORKDIR}/vendor/qcom/opensource/unit-test/kernel-unit-test/virtio_spmi_pmic_unit_test"
