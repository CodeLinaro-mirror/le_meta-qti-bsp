...
SUMMARY = "SoftwareContainer"
DESCRIPTION = "The SoftwareContainer framework"
HOMEPAGE = "https://git.codelinaro.org/clo/le/softwarecontainer/"
LICENSE = "LGPLv2.1"
LIC_FILES_CHKSUM = "file://LICENSE;md5=4fbd65380cdd255951079008b364516c"

DEPENDS = "dbus-glib glibmm ivi-logging jansson lxc"

PV = "1.0+git${SRCREV}"

SRC_URI = "\
    ${PATH_TO_REPO}/external/softwarecontainer/.git;protocol=git;branch=master;destsuffix=softwarecontainer \
...
FILES:${PN}-dbg += "${datadir}/softwarecontainer/examples/*/.debug"
