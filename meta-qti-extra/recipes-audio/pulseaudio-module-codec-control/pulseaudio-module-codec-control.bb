...
SRC_URI = "git://source.codeaurora.org/platform/vendor/qcom-opensource/mm-audio.git;protocol=${PROTO};destsuffix=vendor/qcom/opensource/mm-audio/pulseaudio-module-codec-control;subpath=pulseaudio-module-codec-control;nobranch=1"
