...
SRC_URI = "git://source.codeaurora.org/platform/vendor/qcom-opensource/mm-audio.git;protocol=https;destsuffix=vendor/qcom/opensource/mm-audio/pulseaudio-module-acdb;subpath=pulseaudio-module-acdb;nobranch=1"
