...
SRC_URI:append += "${@bb.utils.contains('MACHINE_MNT_POINTS', '/systemrw', '', 'file://var-cache.mount', d)}"
SRC_URI:append += "${@bb.utils.contains('MACHINE_MNT_POINTS', '/systemrw', '', 'file://var-lib.mount', d)}"
SRC_URI:append += "${@bb.utils.contains('MACHINE_MNT_POINTS', '/systemrw', '', 'file://var-spool.mount', d)}"
