...
HOMEPAGE = "https://source.codeaurora.org/quic/la/device/qcom/common/"

LICENSE = "BSD"
LIC_FILES_CHKSUM = "file://${COREBASE}/meta/files/common-licenses/${LICENSE};md5=3775480a712fc46a69647678acb234cb"
PR = "r0"

SRC_URI = "git://git.codelinaro.org/clo/la/device/qcom/common;protocol=https;nobranch=1;rev=de9a4014a349d23cce6acec077aa648a4a07bcc9;subpath=cryptfs_hw"
