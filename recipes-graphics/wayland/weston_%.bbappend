...
python do_getpatches() {
    ...
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0001-ivi-shell-fix-TODO-which-expects-only-one-screen-in-.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0001-ivi-shell-fix-TODO-which-expects-only-one-screen-in-.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0001-weston-patch-for-wl-shell-emulator.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0001-weston-patch-for-wl-shell-emulator.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0002-ivi-shell-avoid-inserting-a-ivi_layer-to-multiple-sc.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0002-ivi-shell-avoid-inserting-a-ivi_layer-to-multiple-sc.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0003-ivi-shell-fix-layout_layer.view_list-is-not-initiliz.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0003-ivi-shell-fix-layout_layer.view_list-is-not-initiliz.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0004-ivi-shell-remove-a-code-which-expects-only-a-screen-.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0004-ivi-shell-remove-a-code-which-expects-only-a-screen-.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0005-ivi-shell-multi-screen-support.-ivi_layout_screen-to.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0005-ivi-shell-multi-screen-support.-ivi_layout_screen-to.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0006-ivi-shell-transforming-from-a-single-screen-coordina.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0006-ivi-shell-transforming-from-a-single-screen-coordina.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl-demo/-/raw/caf_migration/automotivelinux/chinook/recipes-graphics/wayland/weston/0007-RFR-ivi-shell-multi-screen-support-to-calcuration-of.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0007-RFR-ivi-shell-multi-screen-support-to-calcuration-of.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl/-/raw/caf_migration/automotivelinux/chinook/meta-agl/recipes-graphics/wayland/weston/fix-touchscreen-crash.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/fix-touchscreen-crash.patch"
    os.system(cmd)
    cmd = "wget https://git.codelinaro.org/clo/le/AGL/meta-agl/-/raw/caf_migration/automotivelinux/chinook/meta-ivi-common/recipes-graphics/wayland/weston-ivi-shell/0001-IVI-Shell-use-primary-screen-for-resolution.patch -O ${WORKSPACE}/poky/meta-qti-bsp/recipes-graphics/wayland/weston/0001-IVI-Shell-use-primary-screen-for-resolution.patch"
    os.system(cmd)
}
...
#
DEPENDS += "sdm scalar sdm-noship gbm gbm-headers"
