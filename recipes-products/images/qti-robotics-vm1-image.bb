...
IMAGE_FEATURES += "vm"
do_merge_dtbs[cleandirs] = "${DEPLOY_DIR_IMAGE}/kernel_dtbs/${VM_IMAGE_ALIAS}-dtbs"
do_merge_dtbs() {

    cp -rp ${DEPLOY_DIR_IMAGE}/kernel_dtbs/kalamale_roboticsvm1*.dtb ${DEPLOY_DIR_IMAGE}/kernel_dtbs/${VM_IMAGE_ALIAS}-dtbs/
    ...
    ${DEPLOY_DIR_IMAGE}/kernel_dtbs/${VM_IMAGE_ALIAS}-dtbs/ \
    ${DEPLOY_DIR_IMAGE}/build-artifacts/techpack-dtbos ${DEPLOY_DIR_IMAGE}/merged-${VM_IMAGE_ALIAS}-dtbs/

    mkdtimg create ${DEPLOY_DIR_IMAGE}/${VM_IMAGE_ALIAS}-${DTB_TARGET} --page_size=${PAGE_SIZE} \
    ${DEPLOY_DIR_IMAGE}/merged-${VM_IMAGE_ALIAS}-dtbs/*.dtb
}
